...
class EventRepository implements IEventRepository
{
    ...
    public function getAll(): array
    {
        ...
        SELECT
            ...
            BU.FullName            as BeforeUserFullName,
            BU.RegistrationNumber  as BeforeUserRegistrationNumber,
            BU.Username            as BeforeUserUsername,
            BU.Email               as BeforeUserEmail,
            BU.Phone               as BeforeUserPhone,
            BU.Avatar              as BeforeUserAvatar,
            BU.Role                as BeforeUserRole,
            AU.Id                  as AfterUserId,
            AU.FullName            as AfterUserFullName,
            AU.RegistrationNumber  as AfterUserRegistrationNumber,
            AU.Username            as AfterUserUsername,
            AU.Email               as AfterUserEmail,
            AU.Phone               as AfterUserPhone,
            AU.Avatar              as AfterUserAvatar,
            AU.Role                as AfterUserRole,
            EA.Status              as Status,
            R.Id                   as RoomId,
            R.Code                 as RoomCode,
            R.Name                 as RoomName,
