    ...
    <form class="bordered-container" method="post" action="/rooms" enctype="multipart/form-data">
        ...
        <div class="input-container">
            <div class="mb-4 w-100">
                ...
                <input type="text" class="input-text" id="name-input" name="name" required>
            </div>
            <div class="mb-4 w-100">
                <label for="code-input" class="form-label">Code</label>
                <input type="text" class="input-text" id="code-input" name="code" maxlength="4" required>
            </div>
            <div class="row">
                <div class="col mb-4 w-100">
                    <label for="floor-input" class="form-label">Floor</label>
                    <input type="number" class="input-text" id="floor-input" name="floor" required>
                </div>
                <div class="col mb-4 w-100">
                    <label for="side-input" class="form-label">Side</label>
                    <input type="text" class="input-text" id="side-input" name="side" required>
                </div>
                <div class="col mb-4 w-100">
                    <label for="capacity-input" class="form-label">Capacity</label>
                    <input type="number" class="input-text" id="capacity-input" name="capacity" required>
                </div>
            </div>
            <div class="mb-4 w-100">
