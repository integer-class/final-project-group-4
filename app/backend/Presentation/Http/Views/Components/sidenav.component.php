...
<nav class="sidenav">
    <ul class="sidenav-menu">
        ...
        <li class="sidenav-item <?= View::activeClass('dashboard') ?>">
            <a href="/admin/dashboard" class="sidenav-link">
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 38H18V26H30V38H36V20L24 11L12 20V38ZM8 42V18L24 6L40 18V42H26V30H22V42H8Z"
                          fill="currentColor"/>
                </svg>
            </a>
        </li>
        ...
        <li class="sidenav-item <?= View::activeClass('room-list') ?>">
            <a href="/admin/room-list" class="sidenav-link">
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6 26H10V22H6V26ZM6 34H10V30H6V34ZM6 18H10V14H6V18ZM14 26H42V22H14V26ZM14 34H42V30H14V34ZM14 14V18H42V14H14Z"
                          fill="currentColor"/>
                </svg>
            </a>
        </li>
        ...
        <li class="sidenav-item <?= View::activeClass('schedule') ?>">
            <a href="/admin/schedule" class="sidenav-link">
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="sidenav-item <?= View::activeClass('user-list') ?>">
            <a href="/admin/user-list" class="sidenav-link">
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
